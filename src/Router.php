...
class Router{
    ...
    public $layout = "layouts/default.php"; // layout par défaut (mais possibilité de l'écrasé en redéfinissant la route d'un nouveau layout)
    ...
    public function run(): self
    {
        ...
        $isAdmin = strpos($view, "admin/") !== false; // Si il y a la chaine "admin/" dans '$view' Alors retournera true, sinon false
